...
export const ACCOMMODATIONS: AccommodationItem[] = [
  // 1. Aria Life Hotel (09/28 - 09/30 · 2晚 · 3人)
  {
    ...
    notice: '預訂確認碼：5378.289.674 (PIN: 7405)。住客：HSU CHEN HUNG (3位成人)。不需預約：住宿場所設有私人免費停車設施；住宿全館提供免費 WiFi；客房享湖景與泳池景觀、陽台/露台、空調、電梯直達；不可攜帶寵物。現場以 EUR 320.00 付款。',
  ...
  // 5. Park Hotel Bled (10/07 - 10/08 · 1晚 · 5人 · 3間房)
  {
    ...
    notice: '預訂確認碼：5467.373.177 (PIN: 4721)。5位成人、3間客房 (2間陽台雙人房 + 1間湖景雙人房)，全含早餐。坐落於布萊德湖正前方，是傳奇布萊德傳統奶油蛋糕原創誕生地。住宿附近提供私人停車設施 (每日 €12，無法預約)。',
  ...
  // 6. Villa Benvenuti (10/08 - 10/11 · 3晚 · 5人 · 1 Villa)
  {
    ...
    notice: '預訂確認碼：5942.025.866 (PIN: 3245)。住客：CHEN CHIUNG HUA (5位成人)。實付總額 €636.85 已扣款付訖。入住時需以現金支付 EUR 300 損壞押金（退房檢查無誤後全額退還）。配備洗衣機、烘衣機、廚房、私人泳池與免費私人停車場。',
  ...
  // 7. Charming house Maša (10/11 - 10/13 · 2晚 · 5人 · 1 Villa)
  {
    ...
    paymentMethod: 'Booking.com 扣款付訖 (€419.29，含稅原價 €460.00 扣除 Booking.com 支付 -€40.71)',
    ...
    notice: '預訂確認碼：6233.309.152 (PIN: 2390)。住客：CHEN CHIUNG HUA (5位成人)。實付總額 €419.29 已扣款付訖。附設熱水按摩池、桑拿烤箱、戶外露台、花園山景、洗衣機、全套廚房與免費私人停車場（不需預約）。',
  ...
  // 9. Three Little Birds (10/15 - 10/16 · 1晚 · 5人 · 1 Villa)
  {
    ...
    remainingAmount: 0.00,
    paymentStatus: '已確認 · Booking.com 扣款付訖',
    paymentMethod: 'Booking.com 扣款付訖 (€352.75，含稅原價 €387.00 扣除 Booking.com 支付 -€34.25)',
    ...
    notice: '預訂確認碼：6208.171.806 (PIN: 2882)。住客：CHEN CHIUNG HUA (5位成人)。實付總額 €352.75 已扣款付訖。5 位成人包棟，附設私人泳池、廚房、洗衣機、洗碗機；整間位於地面樓層且輪椅可通行；免費私人停車。',
  ...
  // 12. Hotel Osteria della Pista (10/21 - 10/23 · 2晚 · 5人 · 2間房)
  {
    ...
    notice: '預訂確認碼：6261.889.385 (PIN: 7623)。5 位成人、2 間客房（雙人房 2人 + 三人房 3人），均含每日早餐。入住 14:00～23:30，退房 10:30 前。飯店提供米蘭 MXP 機場接駁專車服務至晚上 23:00。不需預約免費公共停車。',
