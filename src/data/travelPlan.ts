...
export const ACCOMMODATIONS: AccommodationItem[] = [
  // 1. Aria Life Hotel (09/28 - 09/30 · 2晚 · 3人)
  {
    ...
    paymentStatus: '免付訂金 · 現場付款',
    paymentMethod: '現場以 EUR 付款 (EUR 320.00 / 信用卡或現金)',
    meals: '包含每日早餐',
    mealType: 'breakfast',
    hasParking: true,
    hasWasher: false,
    ...
    notice: '不需預約：住宿場所設有私人免費停車設施；住宿全館提供免費 WiFi；客房享湖景與泳池景觀、陽台/露台、空調、電梯直達；不可攜帶寵物。',
  ...
  // 3. Chalet del Capriolo (10/03 - 10/06 · 3晚 · 3人)
  {
    ...
    totalAmount: 856.20,
    paidAmount: 0.00,
    remainingAmount: 856.20,
    cityTaxAmount: 13.50,
    cityTaxNote: '城市稅 TWD 496 (約 €13.50 · 3位成人 × 3晚)，已含於現場付款 EUR 856.20 總額內',
    paymentStatus: '已確認 · 現場信用卡付款',
    paymentMethod: '現場以歐元付款 EUR 856.20 (約 TWD 31,473，含 10% 稅、清潔費 €100 與城市稅；Booking.com 支付補助 -€74.27)',
    refundableDeposit: 'EUR 200 損壞押金 (約 TWD 7,351，入住以信用卡支付，退房後 7 天無損全額退還)',
  ...
  // 4. MANDA Heritage Hotel (10/06 - 10/07 · 1晚 · 5人 · 2間房)
  {
    ...
    notice: '兩間套房均含早餐、免費 Wi-Fi、飲用水、咖啡／茶。單臥室套房為禁菸房 (Non-Smoking) 且附 Twin Beds。',
    address: 'Ul. kneza Borne 24, 10000, Zagreb, Croatia',
    phone: '+385 1 4875 555',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=MANDA+Heritage+Hotel+Zagreb',
  ...
  // 5. Park Hotel Bled (10/07 - 10/08 · 1晚 · 5人 · 3間房)
  {
    ...
    totalAmount: 558.63,
    paidAmount: 0.00,
    remainingAmount: 558.63,
    paymentStatus: '已確認 · 現場/線上付訖',
    paymentMethod: 'Booking.com 預訂 (EUR 558.63)',
    meals: '包含 5 位成人每日早餐',
    mealType: 'breakfast',
    hasParking: true,
    hasWasher: false,
    ...
    notice: '5位成人、3間客房 (2間陽台雙人房 + 1間湖景雙人房)，全含早餐。坐落於布萊德湖正前方，是傳奇布萊德傳統奶油蛋糕原創誕生地。',
    address: 'Cankarjeva cesta 2, 4260 Bled, Slovenia',
    phone: '+386 4 579 1800',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=Park+Hotel+Bled',
  ...
  // 6. Villa Benvenuti (10/08 - 10/11 · 3晚 · 5人 · 1 Villa)
  {
    ...
    paidAmount: 636.85,
    remainingAmount: 0.00,
    paymentStatus: '已付款 (Booking.com 扣款付訖)',
    paymentMethod: 'Booking.com 預付已付款 (€636.85)',
    ...
    notice: '旅費固定採 €636.85 (已付款，不額外加收稅費)。配備洗衣機、烘衣機、廚房與免費私人停車場。',
    address: 'Kaldir 42, 52424 Motovun, Croatia',
    phone: '+385 52 681 700',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=Villa+Benvenuti+Motovun',
  ...
  // 7. Charming house Maša (10/11 - 10/13 · 2晚 · 5人 · 1 Villa)
  {
    ...
    paymentMethod: 'Booking.com 扣款付訖 (EUR 460.00)',
    ...
    notice: '附設熱水按摩池、桑拿烤箱、戶外露台、花園山景、洗衣機、全套廚房與免費私人停車場（不需預約）。',
  ...
  // 8. AC Hotel Split (10/13 - 10/15 · 2晚 · 5人 · 3間房)
  {
    ...
    paidAmount: 1191.00,
    remainingAmount: 0.00,
    paymentStatus: '已確認 · 萬豪官方預訂 (3間/5人)',
    paymentMethod: '萬豪官方預訂信用卡擔保／扣款 (3筆獨立訂單)',
  ...
  // 9. Three Little Birds (10/15 - 10/16 · 1晚 · 5人 · 1 Villa)
  {
    ...
    paidAmount: 387.00,
    remainingAmount: 0.00,
    paymentStatus: '已確認 · Booking.com 預訂',
    paymentMethod: 'Booking.com 扣款 (EUR 387.00)',
    ...
    notice: '5 位成人包棟，附設私人泳池、廚房、洗衣機、洗碗機；整間位於地面樓層且輪椅可通行；免費私人停車。',
    address: 'Vrbanj 142, 21462 Vrbanj, Hvar Island, Croatia',
  ...
  // 11. Tirkiz Apartment (10/18 - 10/21 · 3晚 · 5人 · 1 公寓)
  {
    ...
    remainingAmount: 0.00,
    paymentStatus: '已確認 · Booking.com 扣款付訖',
    paymentMethod: 'Booking.com 線上扣款 (€1,226.93，原價 €1,336.80 扣除 Booking.com 支付 €109.87)',
  ...
  // 12. Holiday Inn Express Milan-Malpensa Airport (10/21 - 10/23 · 2晚 · 5人 · 2間房)
  {
    id: 'stay-holiday-inn-mxp',
    phase: 'croatia',
    name: 'Holiday Inn Express Milan-Malpensa Airport',
    nameEn: 'Holiday Inn Express Milan - Malpensa Airport, Somma Lombardo',
    location: 'Milan Malpensa · 米蘭機場',
    shortLocation: 'Malpensa · Milan Airport',
    roomSummary: '5人 · 2房',
    googleMapsQuery: 'Holiday Inn Express Milan-Malpensa Airport',
    ...
    guestsText: '5 位成人',
    roomsCount: 2,
    roomType: '2 間客房 (Agoda 2人房 ＋ Booking.com 3人房)',
    channel: 'Agoda',
    secondaryChannel: 'Booking.com',
    bookingCode: 'Agoda #1766459466 ＋ Booking.com #6263.541.338',
    currency: 'EUR',
    totalAmount: 670.97, // €266.07 + €404.90 = €670.97
    paidAmount: 670.97,
    remainingAmount: 0.00,
    paymentStatus: '已確認 (Agoda €266.07 ＋ Booking.com €404.90)',
    paymentMethod: 'Agoda 與 Booking.com 各別線上付訖',
    meals: '兩間客房均包含每日自助早餐',
    mealType: 'breakfast',
    hasParking: true,
    hasWasher: false,
    ...
    hasElevator: true,
    isWheelchairAccessible: true,
    amenityHighlights: ['機場旁便利位置', '2間客房(含5人早餐)', '免費私人停車', '接駁巴士直達T1/T2', '24小時接待櫃台'],
    notice: '5 位成人、兩間房、兩筆不同平台訂單：Agoda 2人房 €266.07 ＋ Booking.com 3人房 €404.90，合計 €670.97。兩間房均包含早餐與免費停車。',
    address: 'Via Dante Alighieri 23, 21019 Somma Lombardo VA, Italy',
    phone: '+39 0331 65301',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=Holiday+Inn+Express+Milan+Malpensa+Airport',
    desc: '緊鄰米蘭馬爾彭薩國際機場（MXP），提供現代舒適客房與免費自助熱食早餐。設有免費私人停車場與機場接駁巴士站點，返台前夕最安心便利的住宿選擇。',
    subRooms: [
      {
        roomIndex: 1,
        roomName: '房間 1 · Agoda (2 位成人)',
        roomType: '2 Twin Standard (標準雙床房)',
        guests: '2 位成人',
        guestsCount: 2,
        channel: 'Agoda',
        confirmationCode: '1766459466',
        bookingRef: '26737608',
        price: 266.07,
        currency: 'EUR',
        breakfast: 'Free Breakfast (免費早餐)',
        notes: 'Agoda Booking ID: 1766459466 (Ref: 26737608) · 2 位成人 · 2 晚 · 含早餐 · €266.07'
      },
      {
        roomIndex: 2,
        roomName: '房間 2 · Booking.com (3 位成人)',
        roomType: 'Standard Queen Room with Single Sofa Bed',
        guests: '3 位成人',
        guestsCount: 3,
        channel: 'Booking.com',
        confirmationCode: '6263.541.338',
        price: 404.90,
        currency: 'EUR',
        breakfast: 'Free Breakfast (免費早餐)',
        notes: 'Booking.com 確認碼: 6263.541.338 · 3 位成人 · 2 晚 · 含早餐 · €404.90'
      }
    ],
    splitMembers: CROATIA_5_MEMBERS,
  }
